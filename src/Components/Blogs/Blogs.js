                ...
                <p>
                    ...
                    <table className='text-center mx-auto border-2 border-gray-400'>
                        <tr className='border-2 border-gray-400'>
                            <th className='border-2 border-gray-400 p-8'>Inline</th>
                            <th className='border-2 border-gray-400 p-8'>Block</th>
                            <th className='border-2 border-gray-400 p-8'>Inline-block</th>
                        </tr>
                        <tr className='border-2 border-gray-400'>
                            <td className='border-2 border-gray-400 p-8'>Displays as an element in its actual size with other elements in a line</td>
                            <td className='border-2 border-gray-400 p-8'>Displays as an element on a new line. It takes up the whole width available</td>
                            <td className='border-2 border-gray-400 p-8'>It display as an inline element but it's behavior is like block element</td>
                        </tr>
                        <tr className='border-2 border-gray-400'>
                            <td className='border-2 border-gray-400 p-8'>Height and Width properties will have no effect on those elements</td>
                            <td className='border-2 border-gray-400 p-8'>Height and Width will have effect on block elements</td>
                            <td className='border-2 border-gray-400 p-8'>Height and Width properties work on those elements</td>
                        </tr>
                    </table>
                </p>
            </div>
